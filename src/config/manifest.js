...
export const plans = [
  {
    ...
    period: "mes",
    description:
      "Ideal para empresas que quieren empezar a recibir alertas sin complicaciones.",
    features: [
  ...
  },
  {
    ...
    period: "mes",
    description:
      "Para empresas que quieren gestionar su pipeline de licitaciones desde un panel propio.",
    features: [
  ...
  },
  {
    ...
    period: "mes",
    description:
      "La versión completa. La IA lee los pliegos y comprueba si tu empresa cumple los requisitos.",
    features: [
